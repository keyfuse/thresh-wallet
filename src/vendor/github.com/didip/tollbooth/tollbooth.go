...
func LimitHandler(lmt *limiter.Limiter, next http.Handler) http.HandlerFunc {
...
func LimitFuncHandler(lmt *limiter.Limiter, nextFunc func(http.ResponseWriter, *http.Request)) http.HandlerFunc {
